...
build: deps
	go build github.com/GoogleCloudPlatform/ubbagent/...

test: testdeps
	go test -v -cpu 1,4 github.com/GoogleCloudPlatform/ubbagent/...

clean:
	go clean -i github.com/GoogleCloudPlatform/ubbagent/...
